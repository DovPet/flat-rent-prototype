...
function Search({ searchResults }) {
  ...
  return (
    <div className="h-screen">
      ...
      <main className="mb-8 -mt-[100px] relative mx-42 md:w-[73%] bg-white shadow-2xl m-3 ml-12 p-8 t-0 rounded-2xl mr-10 pb-10 md:ml-40 lg:ml-52 z-10">
        <p className="text-xs ">
